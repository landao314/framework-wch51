...
#endif
#ifndef uint8_tD
typedef unsigned char  data             uint8_tD;
#endif
#ifndef uint16_tD
typedef unsigned short data             uint16_tD;
#endif
#ifndef uint32_tD
typedef unsigned long  data             uint32_tD;
#endif
#ifndef __idata uint8_t
typedef unsigned char  idata            __idata uint8_t;
#endif
#ifndef __idata uint16_t
typedef unsigned short idata            __idata uint16_t;
#endif
#ifndef __idata uuint32_t
typedef unsigned long  idata            __idata uuint32_t;
#endif
#ifndef __xdata uint8_t
typedef unsigned char  xdata            __xdata uint8_t;
#endif
#ifndef __xdata uint16_t
typedef unsigned short xdata            __xdata uint16_t;
#endif
#ifndef __xdata uuint32_t
typedef unsigned long  xdata            __xdata uuint32_t;
#endif
#ifndef uint8_tV
typedef unsigned char volatile          uint8_tV;
#endif
#ifndef uint8_tDV
typedef unsigned char volatile data     uint8_tDV;
#endif
#ifndef __xdata uint8_tV
typedef unsigned char volatile xdata    __xdata uint8_tV;
#endif
#ifndef uint8_tPV
typedef unsigned char volatile pdata    uint8_tPV;
#endif
#ifndef __code uint8_t
typedef const unsigned char code        __code uint8_t;
#endif
#ifndef Puint8_t
...
#endif
#ifndef P__idata uint8_t
typedef unsigned char  idata          *P__idata uint8_t;
#endif
#ifndef P__idata uint16_t
typedef unsigned short idata          *P__idata uint16_t;
#endif
#ifndef P__idata uuint32_t
typedef unsigned long  idata          *P__idata uuint32_t;
#endif
#ifndef P__xdata uint8_t
typedef unsigned char  xdata          *P__xdata uint8_t;
#endif
#ifndef P__xdata uint16_t
typedef unsigned short xdata          *P__xdata uint16_t;
#endif
#ifndef P__xdata uuint32_t
typedef unsigned long  xdata          *P__xdata uuint32_t;
#endif
#ifndef Puint8_tV
typedef unsigned char volatile        *Puint8_tV;
#endif
#ifndef Puint8_tDV
typedef unsigned char volatile data   *Puint8_tDV;
#endif
#ifndef P__xdata uint8_tV
typedef unsigned char volatile xdata  *P__xdata uint8_tV;
#endif
#ifndef Puint8_tPV
typedef unsigned char volatile pdata  *Puint8_tPV;
#endif
#ifndef P__code uint8_t
typedef const unsigned char code      *P__code uint8_t;
#endif
